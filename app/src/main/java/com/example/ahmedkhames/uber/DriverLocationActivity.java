...
public class DriverLocationActivity extends FragmentActivity implements OnMapReadyCallback {
                                ...
                                public void done(ParseException e) {
                                    if (e == null){
                                        ...
                                        Intent directionsIntent = new Intent(Intent.ACTION_VIEW,
                                                Uri.parse("https://maps.google.com/maps?saddr=" + intent.getDoubleExtra("driverLatitude",0) + "," +  intent.getDoubleExtra("driverLongitude",0) + "&daddr=" +
                                                        intent.getDoubleExtra("requestLatitude",0) + ","  + intent.getDoubleExtra("driverLongitude",0)
                                                ));
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        RelativeLayout mapLayout = (RelativeLayout)findViewById(R.id.driverMap);
